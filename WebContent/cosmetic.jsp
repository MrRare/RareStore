...
<body bgcolor="white">
<form action="/RareStore/SearchServlet2">
<div id=front>
...
<img src="Images/rr3.png" id="img">
 <div id="about" class="select">About us</div>
       ...
       <form action="/RareStore/EleServlet" id="z">
<div id="ele" onclick="ele();" class="select">Electronics</div>
</form>

<form action="/RareStore/CosServlet" id="l">
...
<form action="/RareStore/CfilServlet">
...
<%@ page import="product.CosProduct" %>
<%
ArrayList<CosProduct> pro=(ArrayList<CosProduct>)session.getAttribute("product");
/*'Images/" + pro.get(1).getImage() + "'*/
